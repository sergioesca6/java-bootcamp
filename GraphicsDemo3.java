...
public class GraphicsDemo3 extends Canvas
{
	public void paint( Graphics g )
	{
		...
		g.drawLine(50,60,300,150);
		g.drawLine(120,200,300,400);
		...
		g.setFont(new Font("TimesNewRoman", Font.BOLD+Font.ITALIC, 60)); // 60-pt italic bold
		g.drawString("Leander Lions", 300, 350);

		g.setColor(Color.blue);
		g.setFont(Font.decode("TimesNewRoman-BOLDITALIC-60")); // a different way to specify the same font
