...
{
	public static void main( String[] args )   // return not working
	{
		...
		n("Nerd");    // displays the word you pass it beginning with "N"
		...
		t("Tyrone");    // displays the word you pass it beginning with "T"
